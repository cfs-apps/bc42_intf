...
**
**  Purpose:
**    Define mission scope configurations for the BC42 Interface app
**
**  Notes:
...
**       compile time. Use bc42_intf_platform_cfg.h for compile-time
...
#ifndef _bc42_intf_mission_cfg_
#define _bc42_intf_mission_cfg_


#endif /* _bc42_intf_mission_cfg_ */
